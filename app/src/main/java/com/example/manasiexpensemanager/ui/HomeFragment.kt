...
//                }
    ...
    private fun showDialog() {
        ...
        dialog.set_data.setOnClickListener {
        ...
        dialog.cancel_data.setOnClickListener { mAlertDialog.dismiss() }
        mAlertDialog.show()
        ...
        val boardingTextWatcher = object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int){
                ...
                if(cashAmount.isEmpty() || bankAmount.isEmpty()){
                    dialog.set_data.isEnabled = false
                    ...
                    dialog.set_data.isEnabled = true
